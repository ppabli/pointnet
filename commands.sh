# Train PointNet
python main.py --action train --model pointnet --data_dir "/media/pablo/Disco programas/datasets/open3d/Kitti" --output_dir ./output --epochs 50 --batch_size 32 --num_points 4096 --feature_transform

# Train PointNet++
python main.py --action train --model pointnetpp --data_dir "/media/pablo/Disco programas/datasets/open3d/Kitti" --output_dir ./output --epochs 50 --batch_size 32 --num_points 4096
