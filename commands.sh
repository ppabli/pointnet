...
# Train PointNet++
python main.py --action train --model pointnetpp --data_dir "/media/pablo/Disco programas/datasets/open3d/Kitti" --output_dir ./output --epochs 50 --batch_size 24 --num_points 4096
